...
averages <- c(averages, 92.36)
result <- c(result, "Win")

players <- c(players, "Wright")
averages <- c(averages, 89.12)
result <- c(result, "Loss")

players <- c(players, "King")
averages <- c(averages, 101.06)
result <- c(result, "Win")

players <- c(players, "Huybrechts")
averages <- c(averages, 92.53)
result <- c(result, "Loss")

players <- c(players, "Lewis")
averages <- c(averages, 110.51)
result <- c(result, "Win")

players <- c(players, "Gilding")
averages <- c(averages, 92.55)
result <- c(result, "Loss")

players <- c(players, "Anderson")
averages <- c(averages, 94.47)
result <- c(result, "Win")

players <- c(players, "Caven")
averages <- c(averages, 92.03)
result <- c(result, "Loss")
